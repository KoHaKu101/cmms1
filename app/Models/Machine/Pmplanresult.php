...
class Pmplanresult extends Model
{
  ...
  ,'PM_MASTER_STATUS' ,'PM_MASTERPLPAN_REMARK','PM_USER_CHECK','PM_MASTER_DETAIL_VALUE_STD','PM_MASTER_DETAIL_TYPE_INPUT','CHECK_DATE' ,'CREATE_BY' ,'CREATE_TIME' ,'MODIFY_BY' ,'MODIFY_TIME'
  ];
}
