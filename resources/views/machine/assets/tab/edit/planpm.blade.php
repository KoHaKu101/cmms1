...
<div class="tab-pane" id="planpm-1" >
  <div class="row">
    <div class="col-sm-12">
      <div class="jumbotron">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4 form-inline" >
                          ตรวจเช็คล่าสุด
                            ...
                            <button type="button" class="btn btn-success btn-sm mx-1" id="savedate" data-dataunidpmlist="{{$datamasterimps->PM_TEMPLATE_UNID_REF}}" >
